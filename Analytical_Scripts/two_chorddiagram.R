...
plot()
dev.off()
df_internal<-read.csv("internal.csv")
circos.par(start.degree = 180)
levels = c("s_OB1","s_OB2","s_OB3","s_OB5","s_OB7","s_OB8",
           "s_DD1","s_DD2","s_DD3","s_DD5","s_DD7","s_DD8","s_GU1","s_GU5","s_GU7",
           "s_PO7","s_PON2","s_SB1","s_SB2","s_SB3","s_SB5","s_SB7","s_SB8",
           "OB1","OB2","OB3","OB5","OB7","OB8",
           "DD1","DD2","DD3","DD5","DD7","DD8",
           "GU1","GU2","GU3","GU5","GU7","GU8",
           "PO1","PO2","PO3","PO5","PO7","PO8",
           "SB1","SB2","SB3","SB5","SB7","SB8")

grid.col = c(s_OB1="#66c2a5",s_OB2="#66c2a5",s_OB3="#66c2a5",s_OB5="#66c2a5",s_OB7="#66c2a5",s_OB8="#66c2a5",
             OB1="#66c2a5",OB2="#66c2a5",OB3="#66c2a5",OB5="#66c2a5",OB7="#66c2a5",OB8="#66c2a5",
             s_DD1="#8da0cb",s_DD2="#8da0cb",s_DD3="#8da0cb",s_DD5="#8da0cb",s_DD7="#8da0cb",s_DD8="#8da0cb",
             DD1="#8da0cb",DD2="#8da0cb",DD3="#8da0cb",DD5="#8da0cb",DD7="#8da0cb",DD8="#8da0cb",
             ...
             PO1="#a6d854",PO2="#a6d854",PO3="#a6d854",PO5="#a6d854",PO7="#a6d854",PO8="#a6d854",
             s_SB1="#e78ac3",s_SB2="#e78ac3",s_SB3="#e78ac3",s_SB5="#e78ac3",s_SB7="#e78ac3",s_SB8="#e78ac3",
             SB1="#e78ac3",SB2="#e78ac3",SB3="#e78ac3",SB5="#e78ac3",SB7="#e78ac3",SB8="#e78ac3")


circos.par(gap.after = c("s_OB1"=0,"s_OB2"=0,"s_OB3"=0,"s_OB5"=0,"s_OB7"=0,"s_OB8"=5,
                         "s_DD1"=0,"s_DD2"=0,"s_DD3"=0,"s_DD5"=0,"s_DD7"=0,"s_DD8"=3,"s_GU1"=0,"s_GU5"=0,"s_GU7"=3,
                         "s_PO7"=3,"s_PON2"=0,"s_SB1"=0,"s_SB2"=0,"s_SB3"=0,"s_SB5"=0,"s_SB7"=0,"s_SB8"=15,
                         "OB1"=0,"OB2"=0,"OB3"=0,"OB5"=0,"OB7"=0,"OB8"=5,
                         "DD1"=0,"DD2"=0,"DD3"=0,"DD5"=0,"DD7"=0,"DD8"=3,
                         "GU1"=0,"GU2"=0,"GU3"=0,"GU5"=0,"GU7"=0,"GU8"=3,
                         "PO1"=0,"PO2"=0,"PO3"=0,"PO5"=0,"PO7"=0,"PO8"=3,
                         "SB1"=0,"SB2"=0,"SB3"=0,"SB5"=0,"SB7"=0,"SB8"=15
))

s_OB<-c("s_OB1","s_OB2","s_OB3","s_OB5","s_OB7","s_OB8")
s_GU<-c("s_GU1","s_GU5","s_GU7")
s_DD<-c("s_DD1","s_DD2","s_DD3","s_DD5","s_DD7","s_DD8")
s_SB<-c("s_SB1","s_SB2","s_SB3","s_SB5","s_SB7","s_SB8")
s_PO<-c("s_PO7")
OB<-c("OB1","OB2","OB3","OB5","OB7","OB8")
GU<-c("GU1","GU2","GU3","GU5","GU7","GU8")
DD<-c("DD1","DD2","DD3","DD5","DD7","DD8")
SB<-c("SB1","SB2","SB3","SB5","SB7","SB8")
PO<-c("PO1","PO2","PO3","PO5","PO7","PO8")

chordDiagram(df_internal,order=levels,grid.col = grid.col,col = df_internal$color,directional = 1,
...
## surface segment
df_surface<-read.csv("surface_chord.csv")
...
circos.par(gap.after = c("s_OBH1"=0,"s_OBH3"=0,"s_OBH5"=0,"s_OBN1"=0,"s_OBN2"=0,"s_OBN8"=5,
                         "s_DDH5"=0,"s_DDN1"=0,"s_DDN2"=3,
                        "s_SBH3"=0,"s_SBN2"=0,"s_SBN8"=15,
                         "OBN1"=0,"OBN2"=5,
                         "DDH1"=0,"DDH3"=0,"DDH5"=0,"DDN1"=0,"DDN2"=0,"DDN8"=3,
                         "GUH3"=0,"GUN8"=3,"s_PON2"=3,
                         "POH1"=0,"POH5"=0,"PON1"=3,
                         "SBH1"=0,"SBH3"=0,"SBH5"=0,"SBN1"=0,"SBN2"=0,"SBN8"=15
))

s_OB<-c("s_OBH1","s_OBH3","s_OBH5","s_OBN1","s_OBN2","s_OBN8")

s_DD<-c("s_DDH5","s_DDN1","s_DDN2")
s_SB<-c("s_SBH3","s_SBN2","s_SBN8")
s_PO<-c("s_PON2")
OB<-c("OBN1","OBN2")
GU<-c("GUH3","GUN8")
DD<-c("DDH1","DDH3","DDH5","DDN1","DDN2","DDN8")
SB<-c("SBH1","SBH3","SBH5","SBN1","SBN2","SBN8")
PO<-c("POH1","POH5","PON1")

chordDiagram(df_surface,order=levels,grid.col = grid.col,col = df_surface$color,directional = 1,
             direction.type = c("diffHeight", "arrows"),link.arr.type = "big.arrow",
             annotationTrack = c("grid", "axis"),
             preAllocateTracks = list(
               track.height = mm_h(2),
